...
var options = {
  //지도를 생성할 때 필요한 기본 옵션
  center: new kakao.maps.LatLng(37.53, 126.85), //중심좌표
  level: 4, 
};
 ...
 // 인포윈도우 가공하기 // 예약 기능 추가
  ...
  <div class="infowindow">
      ...
      <div class="infowindow-body">
        ...
        <a href="${data.videoUrl}" class="infowindow-btn" target="_blank">영상이동</a> </br>
        <a href="${data.reservation}" class="infowindow-btn" target="_blank">예약</a>
      </div>
    </div>
  `;
}
