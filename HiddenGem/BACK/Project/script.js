...
var options = {
    //지도를 생성할 때 필요한 기본 옵션
    center: new kakao.maps.LatLng(37.53, 126.85), //지도의 중심좌표. 서울 한가운데
...
const dataSet = [
    {
        title: "까치집",
        address: "서울 강서구 초록마을로 149 1층 까치집",
        url: "https://www.youtube.com/watch?v=qqlOX7MADZw",
        category: "한식",
    },
    {
        title: "즉석우동짜장",
...
function getContent(data) {
  ...
  <div class="infowindow">
        ...
        <div class="infowindow-body">
            ...
            <p class = "infowindow-stars">${data.star}</p>
